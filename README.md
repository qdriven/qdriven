...
1. 🚀 Published release [v1.0.1](https://github.com/fluent-qa/ts-lib-starter/releases/tag/v1.0.1) in [fluent-qa/ts-lib-starter](https://github.com/fluent-qa/ts-lib-starter)
2. ❗ Opened issue [#5](https://github.com/fluent-qa/fluent-project-templates/issues/5) in [fluent-qa/fluent-project-templates](https://github.com/fluent-qa/fluent-project-templates)
3. ❗ Opened issue [#79](https://github.com/qdriven/qfluent-go/issues/79) in [qdriven/qfluent-go](https://github.com/qdriven/qfluent-go)
4. ❗ Opened issue [#4](https://github.com/qdriven/self-making/issues/4) in [qdriven/self-making](https://github.com/qdriven/self-making)
5. 🎉 Merged PR [#13](https://github.com/fluent-qa/fluentqa-pybase/pull/13) in [fluent-qa/fluentqa-pybase](https://github.com/fluent-qa/fluentqa-pybase)
